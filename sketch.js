...
function setup() {
   ...
   bottomSprite.scale = 0.4;
	 ...
	 rightSprite = createSprite(840,605,5,125);
	 rightSprite.shapeColor = "green";

   //Create a leftSprite
	 leftSprite = createSprite(750,605,5,125);
   ...
   //Create a right
	 right = Bodies.rectangle(840,605,5,125,{isStatic: true});
	 World.add(world,right);

   //Create a left
   left = Bodies.rectangle(750,605,5,125,{isStatic: true});
